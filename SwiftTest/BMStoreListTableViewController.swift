//
//  BMStoreListTableViewController.swift
//  SwiftTest
//  门店列表
//  Created by 张琳 on 2017/6/27.
...
class BMStoreListTableViewController: UITableViewController,TBEmptyDataSetDelegate,TBEmptyDataSetDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.rowHeight = 89  //行高
    ...
    func loadData() {
        ...
        //////////////请求最近门店///////////////////
        let nearesStoreURL = "\(BMHOST)/custom/queryPUserList?duserCode=\(BMDUSERCODE)&longitude=\(118.7671100000)&latitude=\(31.9755600000)&pageSize=\(self.pageSize)&pageNum=\(self.pageNum!)"
        let params = ["":""]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let dataList = self.dataList{
            ...
            cellView.updateUIWithStore(store: json)
        }
    ...
    func titleForEmptyDataSet(in scrollView: UIScrollView) -> NSAttributedString? {
        ...
        return NSAttributedString(string: "暂无门店信息")
    }
